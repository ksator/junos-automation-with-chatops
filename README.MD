...
- the [network automation content](https://github.com/ksator/chatops_junos/tree/master/automation_content) the bot use.     
...
- Install hubot  
  - I installed it on an ubuntu 14.04 VM  following the below steps:   
    ...
    - Create a new directory, and generate a new instance of hubot in it.   
    - Answer to the questions. About the question "bot adapter". make sure to answer "slack"
  - Here's the hubot installation details for ubuntu 14.04:    
```
...
-	Create a script (the bot dictionnary) that tell your bot what to do based on the slack messages in the chat room. It has to live in the directory "script".    
