...
-	Create a script that tell your bot what to do based on the slack messages in the chat room. Here’s my dictionnary https://github.com/ksator/chatops_junos/blob/master/scripts/junos_automation.coffee.  
