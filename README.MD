...
-	Create a script that tell your bot what to do based on slack messages. Here’s my disctionnary https://github.com/ksator/chatops_junos/blob/master/scripts/junos.coffee.  
...
```
- the slack status for the bot should now appear as active in the chat room! Send slack messages to your bot in order to delegate tasks to him :-)
