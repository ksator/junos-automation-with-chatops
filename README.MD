...
The repo is actually based on slack and hubot and automation content (ansible playbooks, python scripts, jinja2 templates ...) for junos.  
You can delegate junos automation tasks chatting to hubot with slack.  
You will find into this repo: 
- How to use the bot  
  - [Bot capabilities](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#bot-capabilities)
  - [How does it work](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#how-does-it-work)
  - [Chat syntax](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#chat-syntax)
  - [Usage examples](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#usage-examples)
- The [installation instructions](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#installation-instructions) 
- [A dockerized and slack integrated hubot for Junos automation](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#a-dockerized-and-slack-integrated-hubot-for-junos-automation) 
- The [bot dictionnary](https://github.com/ksator/chatops_junos/blob/master/scripts/junos_automation.coffee). This is where you define the bot actions based on chat messages. Hubot scripts are written in CoffeeScript. Hubot scripts have to live in the "scripts" directory.   
- the [network automation content](https://github.com/ksator/chatops_junos/tree/master/automation_content) the bot uses (python scripts, ansible playbooks ...)  
...
You can do it on the same VM that has the bot, so the bot doesnt need to use API to consume the automation content.   
My automation content is based on Ansible and Python: https://github.com/ksator/chatops_junos/tree/master/automation_content.   
...
Here’s the dictionnary I am using https://github.com/ksator/chatops_junos/blob/master/scripts/junos_automation.coffee.  
...
There is a [dokerfile](https://github.com/ksator/junos-automation-with-chatops/blob/master/dockerfile) at the root of the repository.   
It has the details: 
- to install some network automation tools for junos (ansible, python libraries ...)
- to install hubot and its requirements (nodejs, npm ...) 
- to configure hubot for Junos automation  

So this simplify and automate part of the [installation instructions](https://github.com/ksator/junos-automation-with-chatops/blob/master/README.MD#installation-instructions) in the above section.  
Requirement: you need git and docker on your laptop.   

Here's the instructions to use it:  
- clone locally the repository
```
git clone https://github.com/ksator/junos-automation-with-chatops.git
```
- move to your local repository
```
cd junos-automation-with-chatops
```
- adapt the setup to match your network settings (devices ip @, devices credentials, ...)
https://github.com/ksator/junos-automation-with-chatops/tree/master/scripts
https://github.com/ksator/junos-automation-with-chatops/blob/master/scripts/junos_automation.coffee
https://github.com/ksator/junos-automation-with-chatops/tree/master/automation_content
https://github.com/ksator/junos-automation-with-chatops/blob/master/automation_content/hosts 
https://github.com/ksator/junos-automation-with-chatops/tree/master/automation_content/group_vars
https://github.com/ksator/junos-automation-with-chatops/tree/master/automation_content/hosts_vars
https://github.com/ksator/junos-automation-with-chatops/blob/master/ansible.cfg


- optionnaly, apply the desirated changes on the dockerfile on your local repository    
the dockerfile is located at the root repository

- create a docker image based on the local dockerfile
```
docker build -t j-bot-image .
```
- Instanciate the docker image to get a container with the following options: 
  ...
  - -v to add a data volume to the container
